...
import odop from "../images/odopp.jpg";
...
const HomePage = () => {
  ...
  return (
    <Layoutt title={"One District One Product - Best Offers"}>
      {/* banner image  */}
      <div className="homeImages">
        <img src={odop} alt="one district one product" />
      </div>

      <div className="row mt-3 container-fluid home-page">
        <div className="col-md-3 filters">
          {/* Filter via checked  */}
          <h4 className="text-center ">Filter By Districts</h4>
        ...
        <div className="col-md-9">
          <h3 className="text-center">
            All famous products of Jammu & Kashmir UT
          </h3>
